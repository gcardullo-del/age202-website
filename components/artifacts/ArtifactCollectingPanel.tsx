                ...
                {isAvailable ? (
                  <>
                    ...
                    <p className="mt-3 text-sm leading-7 text-white/40">
                      Una volta acquisito, questo Artifact
                      non sarà più disponibile come reperto
                      collezionabile, mentre il suo record
                      museale resterà preservato.
                    </p>
                  </>
                ) : null}
              </div>
                ...
                formattedPrice ? (
                  <>
                    <div className="mb-5 rounded-2xl border border-lime-300/15 bg-lime-300/[0.045] px-5 py-5">
                      ...
                      <div className="mt-4 grid gap-3 text-xs leading-5 text-white/45">
                        ...
                        <span className="flex items-center gap-2">
                          ...
                          AGE202 archive record preserved
                        </span>
                    ...
                    <div className="space-y-5">
                      <div>
                        <p className="mb-3 text-center text-[0.62rem] font-black uppercase tracking-[0.2em] text-lime-300">
                          Acquista direttamente su AGE202
                        </p>
                      ...
                      {vintedUrl ? (
                        <>
                          <div className="flex items-center gap-4">
                            ...
                            <span className="text-[0.6rem] font-bold uppercase tracking-[0.2em] text-white/25">
                              oppure
                            </span>
                          ...
                          <div>
                            <p className="mb-3 text-center text-[0.62rem] font-black uppercase tracking-[0.2em] text-white/35">
                              Acquista tramite marketplace
                            </p>
                            ...
                            <Link
                              ...
                              className="group inline-flex w-full items-center justify-center gap-3 rounded-2xl border border-white/15 bg-white/[0.035] px-6 py-5 text-sm font-black uppercase tracking-[0.17em] text-white transition duration-300 hover:border-lime-300/40 hover:bg-lime-300/[0.06] hover:text-lime-200"
                            >
                              Acquista su Vinted
                            ...
                            <div className="mt-4 text-center">
                              <p className="inline-flex items-center justify-center gap-2 text-xs leading-6 text-white/40">
                                <LockKeyhole className="h-3.5 w-3.5 text-white/35" />

                                Checkout esterno tramite Vinted
                              </p>
                            </div>
                          </div>
                        </>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 px-6 py-6">
                    ...
                    <p className="mt-2 text-sm leading-7 text-white/35">
                      La scheda museale continuerà a essere
                      preservata nell’archivio AGE202.
                    </p>
                  </div>
                )}
              </div>
