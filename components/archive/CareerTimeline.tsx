...
export default function CareerTimeline({
  ...
  return (
    <section className="relative overflow-hidden border-y border-white/[0.07] bg-[#07101E] py-24 sm:py-28 lg:py-36">
      {/* =====================================================
          BACKGROUND
      ====================================================== */}
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1fr] lg:items-end lg:gap-20">
          ...
          <div className="lg:pb-2">
            <p className="max-w-2xl text-base leading-8 text-white/45 sm:text-lg sm:leading-9">
              A chronological record of the moments that shaped{" "}
              <span className="font-semibold text-white/75">
                {champion.name}
              </span>
              , from the professional debut to the defining achievements
              of a historic career.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <TimelineMeta
                label="First chapter"
                value={String(
                  champion.careerTimeline[0]?.year ??
                    champion.debutYear
                )}
              />
              ...
              <TimelineMeta
                ...
                value={String(champion.careerTimeline.length)}
              />
        ...
        <div className="relative mt-20 sm:mt-24 lg:mt-28">
          ...
          <div className="space-y-8 sm:space-y-10 lg:space-y-0">
            {champion.careerTimeline.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-0 top-8 z-10 flex h-10 w-10 items-center justify-center sm:left-2 sm:h-12 sm:w-12 lg:static lg:col-start-2 lg:row-start-1 lg:mx-auto lg:h-16 lg:w-16">
                    <div
                      className="relative flex h-10 w-10 items-center justify-center rounded-full border bg-[#07101E] sm:h-12 sm:w-12 lg:h-14 lg:w-14"
                      style={{
                        borderColor: `${champion.accent}88`,
                        boxShadow: `0 0 0 8px #07101E, 0 0 34px ${champion.accent}22`,
                      }}
                    >
                      <span
        ...
        <div className="mt-20 flex flex-col gap-4 border-t border-white/10 pt-6 font-mono text-[8px] uppercase tracking-[0.22em] text-white/25 sm:flex-row sm:items-center sm:justify-between lg:mt-28">
          <span>
            AGE202 Career Registry · {champion.name}
          </span>

          <span>
            Archive reference · {champion.certificateId}
          </span>
        </div>
      </div>
    </section>
...
function TimelineCard({
  ...
  return (
    <div
      className={[
        "group relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.025] p-7 transition-all duration-500 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.045] sm:p-9",
        align === "right"
          ? "lg:text-right"
          : "lg:text-left",
      ].join(" ")}
    >
      <div
        aria-hidden="true"
        className={[
          "pointer-events-none absolute -top-16 h-44 w-44 rounded-full opacity-0 blur-[70px] transition-opacity duration-500 group-hover:opacity-[0.18]",
          align === "right"
            ? "-left-16"
            : "-right-16",
        ].join(" ")}
      ...
      <div className="relative">
        ...
        <p
          className="mt-8 text-6xl font-black leading-none tracking-[-0.07em] text-white/[0.12] transition-colors duration-500 group-hover:text-white/[0.2] sm:text-7xl"
        >
          {year}
        </p>

        <h3
          className="mt-5 text-2xl font-black leading-tight tracking-[-0.035em] sm:text-3xl"
          style={{
            color: accent,
          }}
        >
