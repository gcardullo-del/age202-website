...
const eras = [
  {
    ...
    slug: "federer",
    color: "#D9FF00",
    description: "The beginning of a legendary dynasty.",
  },
  {
    year: "2005",
    player: "Rafael Nadal",
    slug: "nadal",
    color: "#FF6B35",
    description: "The King of Clay changes tennis forever.",
  },
  {
    year: "2008",
    ...
    slug: "djokovic",
    color: "#00C853",
    description: "A new era of consistency and dominance.",
  },
  {
    year: "2020",
    ...
    slug: "sinner",
    color: "#FF6F00",
    description: "Italian tennis reaches a historic level.",
  },
  {
    year: "2022",
    ...
    slug: "alcaraz",
    color: "#29B6F6",
    description: "A new generation begins.",
  },
];
    ...
    <section className="relative overflow-hidden bg-[#07101E] py-36">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8">
                ...
                <div className="relative h-full overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.03] p-7 transition-all duration-500 group-hover:-translate-y-3 group-hover:border-white/20 group-hover:bg-white/[0.055]">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      ...
                      <span
                        className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/50 transition-all duration-300 group-hover:border-transparent group-hover:text-[#07101E]"
                        style={{
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-white/10 pt-6 font-mono text-[8px] uppercase tracking-[0.22em] text-white/25 sm:flex-row sm:items-center sm:justify-between">
          <span>AGE202 Historical Registry</span>

          <span>Modern Tennis Era · 2003—Present</span>
        </div>
      </div>
    </section>
  );
