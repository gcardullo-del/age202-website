...
export default function LatestArrivals() {
  ...
  return (
    <section
      id="latest-arrivals"
      className="relative overflow-hidden border-b border-white/10 bg-[#08101F] px-5 py-20 sm:px-8 lg:px-12 lg:py-28"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(200,255,0,0.055),transparent_38%)]"
      />
