...
export type LegendStudioSectionId =
  | "identity"
  | "media"
  | "biography"
  | "career"
...
export type LegendStudioSectionStatus =
  | "complete"
  | "warning"
  | "empty"
  | "neutral";

export type LegendStudioSectionItem = {
...
type LegendStudioSidebarProps = {
  activeSection: LegendStudioSectionId;
  onSectionChange: (
    sectionId: LegendStudioSectionId,
  ) => void;
...
const defaultSections: LegendStudioSectionItem[] = [
  {
    id: "identity",
    label: "Identity",
    description: "Name, nation and legend classification",
    status: "neutral",
  },
  {
    id: "media",
  ...
  },
  {
    id: "biography",
    label: "Biography",
    description: "Story, quote and historical profile",
    status: "neutral",
  },
  {
    id: "career",
    label: "Career",
    description: "Career profile and achievements",
    status: "neutral",
  },
  {
    id: "grandSlams",
    label: "Grand Slams",
    description: "Major titles and championship record",
    status: "neutral",
  },
  {
    id: "timeline",
    label: "Timeline",
    description: "Defining milestones and career chronology",
    status: "neutral",
  },
  {
    id: "gallery",
    label: "Gallery",
    description: "Six or seven defining career images",
    status: "neutral",
  },
  {
    id: "legacy",
    label: "Legacy",
    description: "Impact, records and tennis heritage",
    status: "neutral",
  },
  {
    id: "seo",
  ...
  },
  {
    id: "publishing",
    label: "Publishing",
    description: "Visibility and legend archive state",
    status: "neutral",
  },
];
...
export default function LegendStudioSidebar({
  activeSection,
  onSectionChange,
  sections = defaultSections,
  completion = 0,
  warnings = [],
}: LegendStudioSidebarProps) {
  ...
  return (
    <aside className="border-b border-white/10 bg-[#07101D]/55 xl:border-b-0 xl:border-r">
      <div className="p-4 xl:sticky xl:top-20">
        ...
        <nav
          aria-label="Legend Studio sections"
          className="mt-4"
        >
        ...
        {warnings.length > 0 ? (
          ...
          <div className="mt-4 rounded-2xl border border-emerald-400/15 bg-emerald-400/[0.05] p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-white/35">
              Continue completing the remaining sections to reach Legend Ready quality.
            </p>
          </div>
        )}
      </div>
