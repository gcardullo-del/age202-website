          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 sm:p-10">
              ...
              <p className="mt-6 max-w-2xl text-sm leading-7 text-white/65 sm:text-base">
                Discover established champions, rising stars and the next generation
                through a dynamic archive connected to the current ATP Top 50.
              </p>
          ...
          >
            <div>
              ...
              <p className="mt-5 text-sm leading-7 text-white/58">
                A snapshot of the countries represented in the current AGE202 ATP
                archive. Full filtering arrives with Sprint 5.3.
              </p>
            </div>
