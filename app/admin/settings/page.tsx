...
async function updateShippingCountries(
  ...
  if (
    ...
    redirect(
      "/admin/settings?error=no-countries",
    );
  }

  await prisma.museumSetting.upsert({
    where: {
      key: SHIPPING_COUNTRIES_SETTING_KEY,
    },
...
export default async function AdminSettingsPage({
  ...
  return (
    <AdminShell
      title="Settings"
      description="Configure AGE202 commerce and museum operations."
    >
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <AdminPanel className="p-6 sm:p-7">
            ...
            <p className="mt-4 text-sm leading-7 text-white/45">
              Quando collegheremo questa
              configurazione al checkout,
              Stripe mostrerà solamente i
              Paesi attivi. Un cliente di
              un Paese non autorizzato non
              potrà completare
              l&apos;indirizzo di
              spedizione e quindi non
              potrà pagare.
            </p>
          </AdminPanel>
