...
const tennisHistoryFeatures: SeedFeature[] = [
  {
    type: "legend",
    year: 1969,
    name: "Rod Laver",
  ...
  },
  {
    ...
    era: "OPEN_ERA",
    eyebrow: "Legend of History",
    title: "Ice. Precision. Revolution.",
    description:
  ...
  },
  {
    ...
    year: 1980,
    slug: "borg-mcenroe",
    eyebrow: "Iconic Rivalry",
    title: "Fire Meets Ice",
    playerOne: "Björn Borg",
    playerTwo: "John McEnroe",
    description:
  ...
  },
  {
    ...
    era: "OPEN_ERA",
    eyebrow: "Legend of History",
    title: "The Artist and the Rebel",
    description:
  ...
  },
  {
    type: "rivalry",
    year: 1985,
    slug: "evert-navratilova",
    eyebrow: "Iconic Rivalry",
    title: "Two Ways to Rule",
    playerOne: "Chris Evert",
    playerTwo: "Martina Navratilova",
    description:
  ...
  },
  {
    ...
    slug: "sampras-agassi",
    eyebrow: "Iconic Rivalry",
    title: "Two Visions of America",
    playerOne: "Pete Sampras",
    playerTwo: "Andre Agassi",
    description:
...
function mapEra(
  ...
  switch (era) {
    case "OPEN_ERA":
      return TennisHistoryEra.OPEN_ERA;

    case "GOLDEN_ERA":
      /*
       * Il vecchio dataset usava GOLDEN_ERA.
       * Nel nuovo schema Prisma questa enum non esiste:
       * Graf, Sampras e Agassi restano quindi
       * cronologicamente nell'OPEN_ERA.
       */
      return TennisHistoryEra.OPEN_ERA;

    case "MODERN_ERA":
      return TennisHistoryEra.MODERN_ERA;
  }
}
...
async function seedFeature(
  ...
  if (
    ...
    return prisma.tennisHistoryEntry.upsert({
      where: {
        slug:
          feature.slug,
      },
...
async function main() {
  ...
  console.log(
    `Entries da importare: ${tennisHistoryFeatures.length}`,
  );
  console.log("");
  ...
  for (
    const [
      index,
      feature,
    ] of tennisHistoryFeatures.entries()
  ) {
    await seedFeature(
      feature,
      index,
  ...
  console.log("");
  console.log(
    "SEED TENNIS HISTORY COMPLETATO",
  );
  console.log(
    "==============================",
  );
  ...
  console.log(
    `Totale:      ${tennisHistoryFeatures.length}`,
  );
  console.log("");
  console.log(
    "Le immagini restano scollegate: potranno essere assegnate dal Media Picker del CMS.",
  );
  console.log("");
}
